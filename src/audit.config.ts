export const auditConfig = {
  ...
  figma: {
    ...
    /**
     * Figma component name prefixes to exclude from parity checks.
     * Components named "Primitive / X" are design-only building blocks
     * with no React counterpart — they should not appear in "In Figma, not in code".
     */
    excludedFigmaPrefixes: ["Primitive"],
  },
  scoring: {
    weights: {
      parity: 0.3,
