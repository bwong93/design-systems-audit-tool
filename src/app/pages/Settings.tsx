  ...
  return (
    <div className="p-8">
      <div className="max-w-4xl mx-auto space-y-8">
        <h1 className="text-3xl font-bold text-earnest-100">Settings</h1>

        {/* Config */}
        <section className="bg-white rounded-lg border border-earnest-30 p-6">
          <h2 className="font-semibold text-earnest-100 mb-4">Configuration</h2>
...
function ConfigRow({
  ...
  return (
    <div className="flex items-center justify-between py-1 border-b border-earnest-30 last:border-0">
      <span className="text-earnest-80">{label}</span>
      <span className={`text-earnest-100 ${mono ? "font-mono text-xs" : ""}`}>
        {value}
      </span>
    </div>
  );
